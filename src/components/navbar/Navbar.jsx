      ...
      <div className="flex items-center justify-between h-full max-w-5xl px-4 mx-auto">
        ...
        <div className="flex items-center justify-between w-full h-full md:hidden">
          ...
          <NavLink
            ...
            className={({ isActive }) =>
              isActive
                ? 'text-black px-2 py-1 rounded-xs font-bold md:ml-28 lg:ml-72'
                : 'text-white hover:text-slate-950 px-2 py-1 rounded-xs transition-all md:ml-28 lg:ml-72'
            }
          >
            Log In
          </NavLink>
        ...
        <div className="items-center hidden w-full h-full md:flex">
          ...
          <div className="flex justify-center flex-1 space-x-6">
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? 'text-gray-200 px-2 py-1 rounded-xs font-bold'
                  : 'text-white hover:text-gray-300 px-2 py-1 rounded-xs transition-all'
              }
            >
              Home
            </NavLink>
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? 'text-red-400 px-2 py-1 rounded-xs font-bold'
                  : 'text-white hover:text-red-400 px-2 py-1 rounded-xs transition-all'
              }
            >
              Marvel
            </NavLink>
            <NavLink
              ...
              className={({ isActive }) =>
                isActive
                  ? 'text-[#007DBF] px-2 py-1 rounded-xs font-bold'
                  : 'text-white hover:text-[#007DBF] px-2 py-1 rounded-xs transition-all'
              }
            >
              DC
            </NavLink>

...
const Button = ({ text = 'Click Me', onClick = () => {}, type = 'button' }) => {  
    const baseStyle = 'w-[280px] h-[45px] lg:w-[300px] lg:h-[50px] px-6 py-2 rounded-full text-base lg:text-lg font-semibold focus:outline-hidden transition-all duration-300';
